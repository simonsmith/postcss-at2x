  ...
  return function(root, result) {
    ...
    root.walkRules((rule) => {
      ...
      rule.walkDecls(/^background/, (decl) => {
        ...
        const retinaUrl = createRetinaUrl(decl.value, identifier);
        ...
        if (skipMissingRetina && !retinaImageExists(retinaUrl, decl.source, resolveImagePath)) {
          return;
        }
